      ...
      {NAV.map(({ path, emoji, label }) => {
        ...
        return (
          <button key={path} onClick={() => router.push(path)}
            ...
            <div style={{ width: 42, height: 42, borderRadius: 12, background: active ? PURPLE : 'transparent', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, transition: 'background 0.2s' }}>
              {emoji}
            </div>
